...
### Builds on stage 3 (not stage 5), with one fix
...
**One fix carried over from stage 4:** stage 3 stored `color` in a cold array
and skipped the cold write on respawn (to avoid a read-for-ownership miss). That
left `color` *stale* after respawn — `kind` was re-rolled but `color` wasn't,
so the three colored streams looked mixed/muddy. The golden check didn't catch
it (pos/vel only). Stages 4/5 fixed this by deleting the cold array and
computing `color = kindColor(kind)` in render; stage 6 does the same. The audit
predicted this: `color` is a pure function of `kind` (density 0.036 — a 3-entry
dictionary), so it shouldn't be per-particle data at all. The cold array is
gone; color is a render-time lookup. (This also marginally helped perf — the
dead cold array no longer pollutes cache.)
...
|-----------:|--------:|--------:|------------:|------:|------:|--------------:|
|      65000 |   1.695 |   1.634 |       0.910 | 0.54× | 0.56× |     31.9      |
|     262000 |   1.107 |   1.633 |       0.815 | 0.74× | 0.50× |     35.6      |
|    1000000 |   1.102 |   1.670 |       0.848 | 0.77× | 0.51× |     34.2      |
|    4000000 |   1.106 |   1.720 |       0.973 | 0.88× | 0.57× |     29.8      |
|   16000000 |   1.114 |   1.724 |       1.040 | 0.93× | 0.60× |     27.9      |
|   64000000 |   1.137 |   1.727 |       1.050 | 0.92× | 0.61× |     27.6      |

**Stage 6 beats stage 2 at every N≥65K** — the time win stage 3 deferred is
finally claimed (criterion 5 ✅). At 1M: 0.848 vs 1.102 (1.30× faster). At 65K:
0.910 vs 1.695 (1.86× faster). At 64M: 1.050 vs 1.137 (1.08× — the bandwidth
...
=== Correctness: PASS (max delta = 0.00) ===
       ...
       65000 |      29 |       1.8 |          0.910 |        59175.2 |     16899.0 |    31.85 |        39.7
      262000 |      29 |       7.2 |          0.815 |       213626.3 |      4681.1 |    35.57 |       130.0
     1000000 |      29 |      27.7 |          0.848 |       848282.7 |      1178.9 |    34.19 |       512.1
     4000000 |      29 |     110.6 |          0.973 |      3893059.6 |       256.9 |    29.80 |      2340.8
    16000000 |      29 |     442.5 |          1.040 |     16636811.3 |        60.1 |    27.89 |     10026.6
    64000000 |      29 |    1770.0 |          1.050 |     67231356.7 |        14.9 |    27.61 |     40424.2
```
